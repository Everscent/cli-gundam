...
TetrisMino^ TetrisRemoting::CreateMino(cli::array<unsigned char,1> ^bytes, Anaheim::Tetris::TetrisField ^field)
{
...
bool TetrisRemoting::Send(Anaheim::Tetris::TetrisField ^field, Anaheim::Tetris::TetrisMino ^mino, IPEndPoint ^endPoint)
{
	if (!this->isRunning) return false;
